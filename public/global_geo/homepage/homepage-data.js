...
Object.assign(window.AIGCMKT_HOME, {
  ...
  logoAssets: [
      { name: "艾利特机器人", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/elibot.svg", mode: "wordmark", label: false },
      { name: "衍因科技", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/yanyin.svg", mode: "wordmark", label: false },
      { name: "迁移科技", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/transfer-logo.png", mode: "image-only", label: false, size: "transfer" },
      { name: "思谋科技", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/smartmore-icon.png", mode: "mark-label", size: "smartmore" },
      { name: "创冷科技", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/i2cool-tight.png", mode: "image-only", label: false, size: "wide" },
      { name: "WPS AI", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/wpsai.png", mode: "wordmark", label: false },
      { name: "WPS Office", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/wpsoffice.png", mode: "wordmark", label: false },
      { name: "万里牛", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/wanliniu-transparent.png", mode: "image-only", label: false },
      { name: "PingCAP", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/pingcap.png", mode: "wordmark", label: false },
      { name: "Raise3D", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/raise3d-icon.svg", mode: "mark-label" },
      { name: "比亚迪", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/byd.svg", mode: "wordmark", label: false },
      { name: "广汽新能源", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/aion-gacne.png", mode: "image-only", label: false, size: "aion" },
      { name: "Synopsys", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/synopsys-tight.png", mode: "image-only", label: false, size: "wide" },
      { name: "观远数据", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/guandata-logo.png", mode: "image-only", label: false, size: "guandata" },
      { name: "博云科技", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/bocloud.ico", kind: "icon" },
      { name: "伙伴云", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/huoban-logo.png", mode: "image-only", label: false, size: "huoban" },
      { name: "用友", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/yonyou.png", mode: "mark-label" },
      { name: "理邦仪器", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/edan.png", mode: "mark-label" },
      { name: "ZettaKit", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/zettakit.png", mode: "wordmark", label: false },
      { name: "卫瓴", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/weiling.png", mode: "mark-label" },
      { name: "亿方云", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/fangcloud.ico", mode: "mark-label", initial: "亿" },
      { name: "致趣百川", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/beschannels-official.svg", mode: "wordmark", label: false },
      { name: "合盛硅业", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/hoshine-icon.svg", mode: "mark-label" },
      { name: "悠易互通", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/yoyi-tight.png", mode: "image-only", label: false },
      { name: "得帆低代码", src: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/client-logo-marks/defan-tight.png", mode: "image-only", label: false, size: "subtle" }
    ],
  latestItems: [
      {
      ...
      },
      {
        ...
        image: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/cases/wanliniu.png",
        position: "center 26%",
        fit: "top-crop",
        tone: "light"
      },
      ...
      },
      {
        ...
        cta: "案例待发布",
        href: "",
        image: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/cases/elite.png",
        position: "center 46%",
        tone: "light"
      },
      {
      ...
      },
      {
        ...
        cta: "案例待发布",
        href: "",
        image: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/cases/smartmore.png",
        position: "center 50%",
        tone: "light"
      },
      {
        ...
        cta: "案例待发布",
        href: "",
        image: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/cases/raise3d.png",
        position: "10px 48%",
        tone: "light"
      },
      {
        ...
        cta: "案例待发布",
        href: "",
        image: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/cases/i2cool.png",
        position: "center 52%",
        tone: "light"
      },
      {
        ...
        cta: "案例待发布",
        href: "",
        image: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/cases/pingcap.png",
        position: "center 46%",
        tone: "light"
      },
      {
        ...
        cta: "案例待发布",
        href: "",
        image: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/cases/wps-ai.png",
        position: "center 50%",
        tone: "light"
      },
      {
        ...
        cta: "案例待发布",
        href: "",
        image: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/cases/guandata.png",
        position: "center 50%",
        tone: "light"
      },
      {
        ...
        cta: "案例待发布",
        href: "",
        image: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/cases/finclip.png",
        position: "center 50%",
        tone: "light"
      },
      {
        ...
        cta: "案例待发布",
        href: "",
        image: "/aigcmkt-pixijs-demo/global_geo/homepage/assets/cases/wps-bbs.png",
        position: "center 50%",
        tone: "light"
      },
      {
